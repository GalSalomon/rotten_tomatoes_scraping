...
def create_parser(arguments):
    ...
    parser = argparse.ArgumentParser(description="Get the current top Netflx movies accorting to Rotten Tomatoes.")
    parser.add_argument('-s', '--score', metavar='', choices=SCORES_ALLOWED,
                        default='Both', help='The score used. Could be Tomato or Audience. Default is Both')
    ...
    parser.add_argument('-g', '--geners', metavar='', type=str, nargs='*',
                        choices=GENERS, help='List of Geners to filter. Default None')
